    ...
    <div className="grid md:grid-cols-4 gap-6">
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardTitle className="text-2xl font-heading">${(bankroll.balance || 0).toFixed(2)}</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center space-x-2">
            ...
            <span className={`text-sm font-medium ${(balancePercentage || 100) >= 100 ? "text-green-600" : "text-red-600"}`}>
              ...
              {((balancePercentage || 100) - 100).toFixed(1)}%
            </span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardTitle className="text-2xl font-heading">${(bankroll.simulation_balance || 0).toFixed(2)}</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader className="pb-2">
          ...
          <CardTitle className="text-2xl font-heading">{(stats.win_rate || 0).toFixed(1)}%</CardTitle>
        </CardHeader>
        <CardContent>
